<div>
    ...
    <div class="bg-gray-100">
        <div class="  text-gray-800 flex flex-wrap justify-around w-full">
            <div class="p-5 w-48 ">
            ...
            <div class="p-5 w-48 ">
                ...
                <a class="my-3 block" href="/#">Sign in <span class="text-teal-600 text-xs p-1"></span></a><a
                    ...
                    class="my-3 block" href="/#">Demo <span class="text-teal-600 text-xs p-1">New</span></a>
            </div>
            ...
            <div class="p-5 w-48 ">
                ...
                <a class="my-3 block" href="/#">BeCode Brussels
                    Cantersteen 10, 1000 Bruxelles<span
                        class="text-teal-600 text-xs p-1"></span></a><a class="my-3 block" href="/#">contact@Becode.com
    ...
    <div class="bg-gray-100 pt-2 ">
        <div class="flex pb-5 px-3 w-full pt-5 border-t text-gray-800 text-sm flex-col
       md:flex-row ">
